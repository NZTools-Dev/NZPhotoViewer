...
![Main Viewer](screenshots/01_main_viewer.png)

### 2. Dual-Page Manga Reading Mode (Right-to-Left)
![Dual Page Manga](screenshots/02_dual_page_manga.png)

### 3. Webtoon Continuous Vertical Scroll Mode
![Webtoon Scroll](screenshots/03_webtoon_scroll.png)

### 4. Comprehensive Shortcuts & Help
![Shortcuts Modal](screenshots/04_shortcuts_modal.png)

### 5. Settings & One-Click File Associations
![Settings Modal](screenshots/05_settings_modal.png)
